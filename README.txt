...
After that, run loadAll.sql to fill in the new tables. loadAll.sql should also print out each table after inserting elements into them.
You then run queryAll.sql, A2code.sql, and A3code.sql to create the necessary functions.
After you you run all the previously mentioned script, you can run the Juypter Notebook. For A.4, you will have to run transaction.sql.
